"""
Pipeline module for Customer_0_RV.csv data processing.
Loads and transforms customer data using scikit-learn pipeline.
"""
...
def load_data(data_path="../data/Customer_0_RV.csv"):
...
def transform_data():
    ...
    # Load data
    raw_data = load_data()
    print(f"Loaded customer data with shape: {raw_data.shape}")
