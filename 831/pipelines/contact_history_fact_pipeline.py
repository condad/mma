"""
Pipeline module for Contact_History_Fact_0.csv data processing.
Loads and transforms contact history fact data using scikit-learn pipeline.
"""
...
def load_data(data_path="../data/Contact_History_Fact_0.csv"):
    """Load contact history fact data from CSV file."""
...
def transform_data():
    """Load and transform contact history fact data."""
    # Load data
    raw_data = load_data()
    print(f"Loaded contact history fact data with shape: {raw_data.shape}")
