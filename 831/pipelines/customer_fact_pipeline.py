"""
Pipeline module for Customer_Fact_0_V.csv data processing.
Loads and transforms customer fact data using scikit-learn pipeline.
"""
...
def load_data(data_path="../data/Customer_Fact_0_V.csv"):
    """Load customer fact data from CSV file."""
...
def transform_data():
    """Load and transform customer fact data."""
    # Load data
    raw_data = load_data()
    print(f"Loaded customer fact data with shape: {raw_data.shape}")
