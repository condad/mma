"""
Pipeline module for Customer_Score_0_RV.csv data processing.
Loads and transforms customer score data using scikit-learn pipeline.
"""
...
def load_data(data_path="../data/Customer_Score_0_RV.csv"):
    """Load customer score data from CSV file."""
...
def transform_data():
    """Load and transform customer score data."""
    # Load data
    raw_data = load_data()
    print(f"Loaded customer score data with shape: {raw_data.shape}")
